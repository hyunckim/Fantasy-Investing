            ...
            <div className="row">
              <div className="col-lg-5 col-sm-6">
                ...
                <div className="col-lg-5 col-lg-offset-2 col-sm-6">
                  <img className="img-responsive" src="http://res.cloudinary.com/dh7hv7kkd/image/upload/v1493405205/Screen_Shot_2017-04-28_at_11.43.24_AM_dpb7ld.png" alt="" />
                  </div>
                </div>
                ...
                <div className="row">
                  <div className="col-lg-5 col-lg-offset-1 col-sm-push-6  col-sm-6">
                    ...
                    <div className="col-lg-5 col-sm-pull-6  col-sm-6">
                      <img className="img-responsive" src="http://res.cloudinary.com/dh7hv7kkd/image/upload/v1493405397/Screen_Shot_2017-04-28_at_11.44.38_AM_ekqspi.png" alt="" />
                      </div>
                    </div>
                  ...
                  <div className="container">
                    ...
                    <div className="row">
                      <div className="col-lg-5 col-sm-6">
                        ...
                        <div className="col-lg-5 col-lg-offset-2 col-sm-6">
                          <img className="img-responsive" src="http://res.cloudinary.com/dh7hv7kkd/image/upload/v1493405400/Screen_Shot_2017-04-28_at_11.45.23_AM_fycwgs.png" alt="" />
                        </div>
                    </div>
